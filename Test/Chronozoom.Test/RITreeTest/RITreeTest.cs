...
namespace Chronozoom.Test.RITreeTest
{
    ...
    public class RITreeTest
    {
        ...
        {   /* test correctness of ForkNode computations */
            Int64 count, test_start_time = -7333311, test_end_time = 2013;
            Int64 start = test_start_time + 13700000001, end = test_end_time + 13700000001;
            Console.WriteLine(Storage.ForkNode(offset + 3, offset + 7));  //should output 4
            Console.WriteLine(Storage.ForkNode(offset + 29515, offset + 30500));  //should output 29696
            Console.WriteLine(Storage.ForkNode(offset + 13700005424, offset + 13700005585));  //should output 13700005504
            Console.WriteLine(Storage.ForkNode(offset + 3970765138, offset + 6840749504));  //should output 4294967296
            ...
            Console.WriteLine(count + " timeline(s) returned");
            /* test RI tree query */
