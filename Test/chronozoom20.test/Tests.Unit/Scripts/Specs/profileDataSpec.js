...
describe("validUsername() method", function () {
    ...
    var invalidUsernameDataSet = [' ', 'usr', 'veryveryveryveryveryveryveryverylongusername', 'user@name', 'user!@#$%^&*()name', '.username', 'valid@email.com'];
    var validUsernameDataSet = ['user', 'usernameusernameuser', '1234567890', 'username123', 'UserName'];
