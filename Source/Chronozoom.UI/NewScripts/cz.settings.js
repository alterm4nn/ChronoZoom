...
(function (CZ) {
    (function (Settings) {
        Settings.czDataSource = 'dump';// possible values: db, relay, dump
        ...
        Settings.canvasElementAnimationTime = 1300;//duration of animation of resize or transition of canvas element
        
        Settings.canvasElementFadeInTime = 400;// duration of fade in animation of newly added canvas element
        ...
        // Timescale constants
        Settings.maxTickArrangeIterations = 3;// max iterations constant used in creating ticks
        ...
        Settings.tickLength = 25;// length of big tick
        
        Settings.smallTickLength = 12.5;// length of small tick
        ...
        Settings.minLabelSpace = 50;// minimum space (in px) between 2 labels on timescale
        
        Settings.minTickSpace = 8;// minimum space (in px) between 2 ticks on timescale
        
        Settings.minSmallTickSpace = 8;
        Settings.timescaleThickness = 2;// thickness of timescale's baseline and ticks
        ...
        // progresive loading
        Settings.serverUrlBase = document.URL.match(/((?:http:\/\/)?(?:[0-9a-zA-Z.:\-]+)(?:\/[^.]+\/)?)(.*)/)[1];
        Settings.minTimelineWidth = 100;// px
