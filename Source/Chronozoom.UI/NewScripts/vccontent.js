            ...
            this.changeZoomLevel = function (curZl, newZl) {
                if(newZl >= CZ.Settings.contentItemShowContentZoomLevel) {
                    ...
                    if(contentItem.mediaType === 'image') {
                        imageElem = addSeadragonImage(container, layerid, mediaID, vx + leftOffset, mediaTop, contentWidth, mediaHeight, CZ.Settings.mediaContentElementZIndex, contentItem.mediaUrl);
                    } else if(contentItem.mediaType === 'video') {
                        addVideo(container, layerid, mediaID, contentItem.mediaUrl, vx + leftOffset, mediaTop, contentWidth, mediaHeight, CZ.Settings.mediaContentElementZIndex);
                        ...
                        addAudio(container, layerid, mediaID, contentItem.mediaUrl, vx + leftOffset, mediaTop, contentWidth, mediaHeight, CZ.Settings.mediaContentElementZIndex);
                    } else if(contentItem.mediaType === 'pdf') {
                        addPdf(container, layerid, mediaID, contentItem.mediaUrl, vx + leftOffset, mediaTop, contentWidth, mediaHeight, CZ.Settings.mediaContentElementZIndex);
                    }
                    // Title
