    ...
    module HomePageViewModel {
        ...
        $(document).ready(function () {
            ...
            if (window.location.hash)
                ChronoZoom.Common.startHash = window.location.hash; // to be processes after the data is loaded
            ...
            ChronoZoom.Common.controller.onAnimationComplete.push(
                                function (id) {
                                    ...
                                    if (ChronoZoom.Tours.tour != undefined && ChronoZoom.Tours.tour.state != "finished") //enabling wathcing for user activity while playing the bookmark
            ...
            ChronoZoom.Common.vc.bind("breadCrumbsChanged", function (breadCrumbsEvent) { //reacting on the event when the first timeline that contains whole visible region is changed
            ...
            var vp = ChronoZoom.Common.vc.virtualCanvas("getViewport");
            ChronoZoom.Common.vc.virtualCanvas("setVisible", ChronoZoom.VCContent.getVisibleForElement({ x: -13700000000, y: 0, width: 13700000000, height: 5535444444.444445 }, 1.0, vp));
            ChronoZoom.Common.updateAxis(ChronoZoom.Common.vc, ChronoZoom.Common.ax);
