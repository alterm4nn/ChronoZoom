...
(function (CZ) {
    ...
    function CosmosTickSource() {
        ...
        this.createTicks = function (range) {
            ...
            var min = Math.floor((this.range.min - this.present) / dx);
            var max = Math.floor((this.range.max - this.present) / dx);
            var count = max - min + 1;
            var num = 0;
            var x0 = min * dx;
            if(dx == 2) {
