...
(<any>Date).ext = {};
(<any>Date).ext.util = {};
(<any>Date).ext.util.xPad = function(a, c, b) {
...
(<any>Date).prototype.locale = "en-GB";
if ((<any>document).getElementsByTagName("html") && (<any>document).getElementsByTagName("html")[0].lang) {
    (<any>Date).prototype.locale = (<any>document).getElementsByTagName("html")[0].lang
}
(<any>Date).ext.locales = {};
(<any>Date).ext.locales.en = {
...
(<any>Date).ext.locales["en-US"] = (<any>Date).ext.locales.en;
(<any>Date).ext.locales["en-US"].c = "%a %d %b %Y %r %Z";
(<any>Date).ext.locales["en-US"].x = "%D";
(<any>Date).ext.locales["en-US"].X = "%r";
(<any>Date).ext.locales["en-GB"] = (<any>Date).ext.locales.en;
(<any>Date).ext.locales["en-AU"] = (<any>Date).ext.locales["en-GB"];
(<any>Date).ext.formats = {
    a: function(a) {
        return (<any>Date).ext.locales[a.locale].a[a.getDay()]
    },
    A: function(a) {
        return (<any>Date).ext.locales[a.locale].A[a.getDay()]
    },
    b: function(a) {
        return (<any>Date).ext.locales[a.locale].b[a.getMonth()]
    },
    B: function(a) {
        return (<any>Date).ext.locales[a.locale].B[a.getMonth()]
    },
    c: "toLocaleString",
    C: function(a) {
        return (<any>Date).ext.util.xPad(parseInt((a.getFullYear() / 100).toString(), 10), 0)
    },
    d: ["getDate", "0"],
    e: ["getDate", " "],
    g: function(a) {
        return (<any>Date).ext.util.xPad(parseInt(((<any>Date).ext.util.G(a) / 100).toString(), 10), 0)
    },
    G: function(c) {
        var e: any = c.getFullYear();
        var b: any = parseInt((<any>Date).ext.formats.V(c), 10);
        var a: any = parseInt((<any>Date).ext.formats.W(c), 10);
        if (a > b) {
            e++
        } else {
            if (a === 0 && b >= 52) {
    ...
    H: ["getHours", "0"],
    I: function(b) {
        var a: any = b.getHours() % 12;
        return (<any>Date).ext.util.xPad(a === 0 ? 12 : a, 0)
    },
    j: function(c) {
        var a: any = c - new Date("" + c.getFullYear() + "/1/1 GMT");
        a += c.getTimezoneOffset() * 60000;
        var b: any = parseInt((a / 60000 / 60 / 24).toString(), 10) + 1;
        return (<any>Date).ext.util.xPad(b, 0, 100)
    },
    m: function(a) {
        return (<any>Date).ext.util.xPad(a.getMonth() + 1, 0)
    },
    M: ["getMinutes", "0"],
    p: function(a) {
        return (<any>Date).ext.locales[a.locale].p[a.getHours() >= 12 ? 1 : 0]
    },
    P: function(a) {
        return (<any>Date).ext.locales[a.locale].P[a.getHours() >= 12 ? 1 : 0]
    },
    ...
    U: function(e) {
        var a: any = parseInt((<any>Date).ext.formats.j(e), 10);
        var c: any = 6 - e.getDay();
        var b: any = parseInt(((a + c) / 7).toString(), 10);
        return (<any>Date).ext.util.xPad(b, 0)
    },
    V: function(e) {
        var c: any = parseInt((<any>Date).ext.formats.W(e), 10);
        var a: any = (new Date("" + e.getFullYear() + "/1/1")).getDay();
        var b: any = c + (a > 4 || a <= 1 ? 0 : 1);
        if (b == 53 && (new Date("" + e.getFullYear() + "/12/31")).getDay() < 4) {
            b = 1
        } else {
            if (b === 0) {
                b = (<any>Date).ext.formats.V(new Date("" + (e.getFullYear() - 1) + "/12/31"))
            }
        }
        return (<any>Date).ext.util.xPad(b, 0)
    },
    ...
    W: function(e) {
        var a: any = parseInt((<any>Date).ext.formats.j(e), 10);
        var c: any = 7 - (<any>Date).ext.formats.u(e);
        var b: any = parseInt(((a + c) / 7).toString(), 10);
        return (<any>Date).ext.util.xPad(b, 0, 10)
    },
    y: function(a) {
        return (<any>Date).ext.util.xPad(a.getFullYear() % 100, 0)
    },
    Y: "getFullYear",
    z: function(c) {
        var b: any = c.getTimezoneOffset();
        var a: any = (<any>Date).ext.util.xPad(parseInt((Math.abs(b / 60)).toString(), 10), 0);
        var e: any = (<any>Date).ext.util.xPad(b % 60, 0);
        return (b > 0 ? "-" : "+") + a + e
    },
    Z: function(a) {
...
(<any>Date).ext.aggregates.z = (<any>Date).ext.formats.z(new Date());
(<any>Date).ext.aggregates.Z = (<any>Date).ext.formats.Z(new Date());
(<any>Date).ext.unsupported = {};
(<any>Date).prototype.strftime = function(a) {
    if (!(this.locale in (<any>Date).ext.locales)) {
        if (this.locale.replace(/-[a-zA-Z]+$/, "") in (<any>Date).ext.locales) {
    ...
    while (a.match(/%[cDhnrRtTxXzZ]/)) {
        a = a.replace(/%([cDhnrRtTxXzZ])/g, function(e, d) {
            var g: any = (<any>Date).ext.aggregates[d];
            return (g == "locale" ? (<any>Date).ext.locales[c.locale][d] : g)
        })
    }
    var b: any = a.replace(/%([aAbBCdegGHIjmMpPSuUVwWyY%])/g, function(e, d) {
        var g: any = (<any>Date).ext.formats[d];
        if (typeof(g) == "string") {
            return c[g]()
        } else {
            if (typeof(g) == "function") {
                ...
                if (typeof(g) == "object" && typeof(g[0]) == "string") {
                    return (<any>Date).ext.util.xPad(c[g[0]](), g[1])
                } else {
                    return d
                }
            }
...
function RGBColorParser(f) {
    ...
    for (var c: any = 0; c < e.length; c++) {
        var j: any = e[c].re;
        var a: any = e[c].process;
        var h: any = j.exec(f);
        if (h) {
            var d: any = a(h);
            this.r = d[0];
    ...
    this.toHex = function() {
        var l: any = this.r.toString(16);
        var k: any = this.g.toString(16);
        var i: any = this.b.toString(16);
        if (l.length == 1) {
            l = "0" + l
        }
        if (k.length == 1) {
...
function printStackTrace(b) {
    ...
    var c: any = b.e || null,
        e: any = !! b.guess;
    var d: any = new printStackTrace.implementation(),
        a: any = d.run(c);
...
printStackTrace.implementation.prototype = {
    ...
    mode: function(a) {
        if (a["arguments"] && a.stack) {
            ...
            if (typeof a.message === "string" && typeof window !== "undefined" && (<any>window).opera) {
                if (!a.stacktrace) {
                    return "opera9"
                }
    ...
    opera11: function(g) {
        ...
        var k: any = g.stacktrace.split("\n"),
            l = [];
        for (var c: any = 0, f = k.length; c < f; c += 2) {
            var d: any = h.exec(k[c]);
            if (d) {
                var j: any = d[4] + ":" + d[1] + ":" + d[2];
                var b: any = d[3] || "global code";
    ...
    opera10b: function(g) {
        var a: any = "{anonymous}",
            h = /^(.*)@(.+):(\d+)$/;
        var j: any = g.stacktrace.split("\n"),
            k = [];
        for (var c: any = 0, f = j.length; c < f; c++) {
            var d: any = h.exec(j[c]);
            if (d) {
                var b: any = d[1] ? (d[1] + "()") : "global code";
                k.push(b + "@" + d[2] + ":" + d[3])
            }
        }
        return k
    ...
    opera10a: function(g) {
        ...
        var j: any = g.stacktrace.split("\n"),
            k = [];
        for (var c: any = 0, f = j.length; c < f; c += 2) {
            var d: any = h.exec(j[c]);
            if (d) {
                var b: any = d[3] || a;
    ...
    opera9: function(j) {
        ...
        var c: any = j.message.split("\n"),
            b = [];
        for (var g: any = 2, a = c.length; g < a; g += 2) {
            var f: any = h.exec(c[g]);
            if (f) {
    ...
    stringifyArguments: function(c) {
        var b: any = [];
        var e: any = Array.prototype.slice;
    ...
    sourceCache: {},
    ajax: function(a) {
        var b: any = this.createXMLHTTPObject();
        if (b) {
            try {
                b.open("GET", a, false);
                b.send(null);
    ...
    guessAnonymousFunctions: function(k) {
        for (var g: any = 0; g < k.length; ++g) {
            var f: any = /\{anonymous\}\(.*\)@(.*)/,
                l = /^(.*?)(?::(\d+))(?::(\d+))?(?: -- .+)?$/,
                b = k[g],
                c = f.exec(b);
            if (c) {
                var e: any = l.exec(c[1]),
                    d = e[1],
                    a = e[2],
                    j = e[3] || 0;
                if (d && this.isSameDomain(d) && a) {
                    var h: any = this.guessAnonymousFunction(d, a, j);
    ...
    findFunctionName: function(a, e) {
        var g: any = /function\s+([^(]*?)\s*\(([^)]*)\)/;
        var k: any = /['"]?([0-9A-Za-z_]+)['"]?\s*[:=]\s*function\b/;
        var h: any = /['"]?([0-9A-Za-z_]+)['"]?\s*[:=]\s*(?:eval|new Function)\b/;
        var b: any = "",
            l, j = Math.min(e, 20),
            d, c;
        for (var f: any = 0; f < j; ++f) {
            l = a[e - f - 1];
            c = l.indexOf("//");
            if (c >= 0) {
                l = l.substr(0, c)
...
(<any>CanvasRenderingContext2D).prototype.installPattern = function(e) {
    ...
    var g: any = [0, 0];
    var b: any = [];
    var f: any = this.beginPath;
    var d: any = this.lineTo;
    var c: any = this.moveTo;
    var a: any = this.stroke;
    ...
    this.stroke = function() {
        ...
        for (var p: any = 0; p < b.length; p++) {
            var o: any = b[p];
            var l: any = o[0][0],
                u = o[0][1];
            for (var n: any = 1; n < o.length; n++) {
                var h: any = o[n][0],
                    s = o[n][1];
                this.save();
                var w: any = (h - l);
                var v: any = (s - u);
                var r: any = Math.sqrt(w * w + v * v);
                var k: any = Math.atan2(v, w);
                this.translate(l, u);
                c.call(this, 0, 0);
                this.rotate(k);
                var m: any = g[0];
...
(<any>CanvasRenderingContext2D).prototype.uninstallPattern = function() {
    throw "Must install a line pattern before uninstalling it."
};
var DygraphOptions = (function() {
    var a: any = function(b) {
        this.dygraph_ = b;
        this.yAxes_ = [];
        this.xAxis_ = {};
        this.series_ = {};
    ...
    a.prototype.reparseSeries = function() {
        ...
        this.series_ = {};
        var h: any = !this.user_.series;
        if (h) {
            var c: any = 0;
            for (var j: any = 0; j < this.labels_.length; j++) {
                var i: any = this.labels_[j];
                var e: any = this.user_[i] || {};
                var b: any = 0;
                var d: any = e.axis;
                if (typeof(d) == "object") {
                    b = ++c;
            ...
            for (var j: any = 0; j < this.labels_.length; j++) {
                var i: any = this.labels_[j];
                var e: any = this.series_[i]["options"];
                var d: any = e.axis;
                if (typeof(d) == "string") {
                    ...
                    var b: any = this.series_[d].yAxis;
            ...
            for (var j: any = 0; j < this.labels_.length; j++) {
                var i: any = this.labels_[j];
                var e: any = this.user_.series[i] || {};
                var b: any = a.axisToIndex_(e.axis);
                this.series_[i] = {
                    idx: j,
                    yAxis: b,
                    options: e
    ...
    a.prototype.get = function(c) {
        var b: any = this.getGlobalUser_(c);
        if (b !== null) {
            return b
        }
    ...
    a.prototype.getForAxis = function(d, e) {
        ...
        var g: any = (f == -1) ? this.xAxis_ : this.yAxes_[f];
        if (g) {
            var h: any = g.options;
        ...
        var c: any = this.getGlobalUser_(d);
        if (c !== null) {
            return c
        }
        var b: any = Dygraph.DEFAULT_ATTRS.axes[i];
...
"use strict";
var DygraphLayout: any = function(a) {
    this.dygraph_ = a;
    this.datasets = [];
    this.setNames = [];
    this.annotations = [];
...
DygraphLayout.prototype.setAnnotations = function(d) {
    this.annotations = [];
    var e: any = this.attr_("xValueParser") || function(a) {
            return a
        };
    for (var c: any = 0; c < d.length; c++) {
        var b: any = {};
...
DygraphLayout.prototype._evaluateLimits = function() {
    var a: any = this.dygraph_.xAxisRange();
    this.minxval = a[0];
    this.maxxval = a[1];
    var d: any = a[1] - a[0];
    this.xscale = (d !== 0 ? 1 / d : 1);
    for (var b: any = 0; b < this.yAxes_.length; b++) {
        var c: any = this.yAxes_[b];
...
DygraphLayout.prototype._evaluateLineCharts = function() {
    var c: any = this.attr_("connectSeparatedPoints");
    ...
    for (var a: any = 0; a < this.datasets.length; a++) {
        var f: any = this.datasets[a];
        var h: any = this.setNames[a];
        var b: any = this.dygraph_.axisPropertiesForSeries(h);
        var i: any = this.dygraph_.attributes_.getForSeries("logscale", h);
        var o: any = new Array(f.length);
        for (var e: any = 0; e < f.length; e++) {
            var n: any = f[e];
            var d: any = DygraphLayout.parseFloat_(n[0]);
            var l: any = DygraphLayout.parseFloat_(n[1]);
            var m: any = (d - this.minxval) * this.xscale;
            var g: any = DygraphLayout._calcYNormal(b, l, i);
            if (c && n[1] === null) {
                l = null
            }
            o[e] = {
...
DygraphLayout.prototype._evaluateLineTicks = function() {
    ...
    for (d = 0; d < this.yAxes_.length; d++) {
        var e: any = this.yAxes_[d];
        for (var a: any = 0; a < e.ticks.length; a++) {
            c = e.ticks[a];
            b = c.label;
...
DygraphLayout.prototype.evaluateWithError = function() {
    ...
    var h: any = 0;
    for (var a: any = 0; a < this.datasets.length; ++a) {
        var p: any = this.points[a];
        var g: any = 0;
        var f: any = this.datasets[a];
        var l: any = this.setNames[a];
        var e: any = this.dygraph_.axisPropertiesForSeries(l);
        var m: any = this.dygraph_.attributes_.getForSeries("logscale", l);
        for (g = 0; g < f.length; g++, h++) {
            var q: any = f[g];
            var c: any = DygraphLayout.parseFloat_(q[0]);
            var n: any = DygraphLayout.parseFloat_(q[1]);
            if (c == p[g].xval && n == p[g].yval) {
                var k: any = DygraphLayout.parseFloat_(q[2]);
                var d: any = DygraphLayout.parseFloat_(q[3]);
                var o: any = n - k;
                var b: any = n + d;
...
DygraphLayout.prototype._evaluateAnnotations = function() {
    ...
    for (var h: any = 0; h < this.points.length; h++) {
        var e: any = this.points[h];
        for (d = 0; d < e.length; d++) {
            var f: any = e[d];
            var c: any = f.xval + "," + f.name;
            if (c in g) {
                f.annotation = g[c];
...
var DygraphCanvasRenderer = function(d, c, b, e) {
    ...
    if (this.dygraph_.isUsingExcanvas_) {
        ...
        if (!Dygraph.isAndroid()) {
            var a: any = this.dygraph_.canvas_ctx_;
            a.beginPath();
...
DygraphCanvasRenderer.isSupported = function(f) {
    ...
    try {
        if (typeof(f) == "undefined" || f === null) {
            b = (<any>document).createElement("canvas")
        } else {
            b = f
        }
        b.getContext("2d")
    } catch (c) {
        var d: any = navigator.appVersion.match(/MSIE (\d\.\d)/);
        var a: any = (navigator.userAgent.toLowerCase().indexOf("opera") != -1);
        if ((!d) || (d[1] < 6) || (a)) {
            return false
        }
        return true
...
DygraphCanvasRenderer.prototype._createIEClipArea = function() {
    var g: any = "dygraph-clip-div";
    var f: any = this.dygraph_.graphDiv;
    for (var e: any = f.childNodes.length - 1; e >= 0; e--) {
        if (f.childNodes[e].className == g) {
            f.removeChild(f.childNodes[e])
        }
    }
    var c: any = (<any>document).bgColor;
    var d: any = this.dygraph_.graphDiv;
    while (d != document) {
        var a: any = d.currentStyle.backgroundColor;
        if (a && a != "transparent") {
            c = a;
            break
        }
    ...
    function b(j) {
        ...
        var i: any = (<any>document).createElement("div");
        i.className = g;
...
DygraphCanvasRenderer._drawStyledLine = function(i, a, m, q, f, n, d) {
    var h: any = i.dygraph;
    var c: any = h.getOption("stepPlot", i.setName);
    if (!Dygraph.isArrayLike(q)) {
        q = null
    }
    var l: any = h.getOption("drawGapEdgePoints", i.setName);
    var o: any = i.points;
    var k: any = Dygraph.createIterator(o, 0, o.length, DygraphCanvasRenderer._getIteratorPredicate(h.getOption("connectSeparatedPoints")));
    var j: any = q && (q.length >= 2);
    var p: any = i.drawingContext;
    p.save();
    if (j) {
        p.installPattern(q)
    }
    var b: any = DygraphCanvasRenderer._drawSeries(i, k, m, d, f, l, c, a);
...
DygraphCanvasRenderer._drawSeries = function(v, t, m, h, p, s, g, q) {
    ...
    var l: any = [];
    var f: any = true;
    var n: any = v.drawingContext;
    n.beginPath();
    n.strokeStyle = q;
    n.lineWidth = m;
    var c: any = t.array_;
    var u: any = t.end_;
    var a: any = t.predicate_;
    for (var r: any = t.start_; r < u; r++) {
        o = c[r];
        if (a) {
            while (r < u && !a(c, r)) {
                r++
...
DygraphCanvasRenderer._drawPointsOnLine = function(h, i, f, d, g) {
    var c: any = h.drawingContext;
    for (var b: any = 0; b < i.length; b++) {
        var a: any = i[b];
        c.save();
...
DygraphCanvasRenderer.prototype._updatePoints = function() {
    var e: any = this.layout.points;
    for (var c: any = e.length; c--;) {
        var d: any = e[c];
        for (var b: any = d.length; b--;) {
            var a: any = d[b];
...
DygraphCanvasRenderer.prototype._renderLineChart = function(g, u) {
    var h: any = u || this.elementContext;
    var n: any;
    var a: any = this.layout.points;
    var s: any = this.layout.setNames;
    var b: any;
    this.colors = this.dygraph_.colorsMap_;
    var o: any = this.attr_("plotter");
    var f: any = o;
    ...
    for (n = 0; n < s.length; n++) {
        b = s[n];
        var t: any = this.attr_("plotter", b);
        if (t == o) {
            continue
        }
        c[b] = t
    ...
    for (n = 0; n < f.length; n++) {
        var r: any = f[n];
        var q: any = (n == f.length - 1);
        for (var l: any = 0; l < a.length; l++) {
            b = s[l];
            if (g && b != g) {
                continue
            }
            ...
            var k: any = this.colors[b];
            var d: any = this.dygraph_.getOption("strokeWidth", b);
            h.save();
            h.strokeStyle = k;
            h.lineWidth = d;
            e({
...
DygraphCanvasRenderer._linePlotter = function(f) {
    var d: any = f.dygraph;
    var h: any = f.setName;
    var i: any = f.strokeWidth;
    var a: any = d.getOption("strokeBorderWidth", h);
    var j: any = d.getOption("drawPointCallback", h) || Dygraph.Circles.DEFAULT;
    var k: any = d.getOption("strokePattern", h);
    var c: any = d.getOption("drawPoints", h);
    var b: any = d.getOption("pointSize", h);
    if (a && i) {
...
DygraphCanvasRenderer._errorPlotter = function(s) {
    var r: any = s.dygraph;
    var f: any = s.setName;
    var t: any = r.getOption("errorBars") || r.getOption("customBars");
    if (!t) {
        return
    }
    var k: any = r.getOption("fillGraph", f);
    if (k) {
        r.warn("Can't use fillGraph option with error bars")
    }
    var m: any = s.drawingContext;
    var n: any = s.color;
    var o: any = r.getOption("fillAlpha", f);
    var i: any = r.getOption("stepPlot", f);
    var p: any = s.points;
    var q: any = Dygraph.createIterator(p, 0, p.length, DygraphCanvasRenderer._getIteratorPredicate(r.getOption("connectSeparatedPoints")));
    var j: any;
    var h: any = NaN;
    var c: any = NaN;
    var d: any = [-1, -1];
    var a: any = new RGBColorParser(n);
    var u: any = "rgba(" + a.r + "," + a.g + "," + a.b + "," + o + ")";
    m.fillStyle = u;
    m.beginPath();
    var b: any = function(e) {
...
DygraphCanvasRenderer._fillPlotter = function(F) {
    ...
    var D: any = F.dygraph;
    var I: any = D.getLabels().slice(1);
    for (var C: any = I.length; C >= 0; C--) {
        if (!D.visibility()[C]) {
            I.splice(C, 1)
        }
    }
    var h: any = (function() {
        for (var e: any = 0; e < I.length; e++) {
    ...
    var w: any = F.drawingContext;
    var E: any = F.plotArea;
    var c: any = F.allSeriesPoints;
    var z: any = c.length;
    var y: any = D.getOption("fillAlpha");
    var k: any = D.getOption("stackedGraph");
    var q: any = D.getColors();
    var s: any = {};
    var a: any;
    var r: any;
    for (var u: any = z - 1; u >= 0; u--) {
        var n: any = I[u];
        if (!D.getOption("fillGraph", n)) {
            continue
        }
        var p: any = D.getOption("stepPlot", n);
        var x: any = q[u];
        var f: any = D.axisPropertiesForSeries(n);
        var d: any = 1 + f.minyval * f.yscale;
        if (d < 0) {
            d = 0
        } else {
            if (d > 1) {
        ...
        d = E.h * d + E.y;
        var B: any = c[u];
        var A: any = Dygraph.createIterator(B, 0, B.length, DygraphCanvasRenderer._getIteratorPredicate(D.getOption("connectSeparatedPoints")));
        var m: any = NaN;
        var l: any = [-1, -1];
        var t: any;
        var b: any = new RGBColorParser(x);
        var H: any = "rgba(" + b.r + "," + b.g + "," + b.b + "," + y + ")";
        w.fillStyle = H;
        w.beginPath();
        var j, G = true;
        while (A.hasNext) {
...
"use strict";
var Dygraph: any = function(d, c, b, a) {
    if (a !== undefined) {
...
Dygraph.numberValueFormatter = function(s, a, u, l) {
    ...
    var c: any = a("digitsAfterDecimal");
    var o: any = a("maxNumberWidth");
    var b: any = a("labelsKMB");
    var r: any = a("labelsKMG2");
    var q: any;
    ...
    if (b || r) {
        ...
        var p: any = Math.abs(s);
        var d: any = Dygraph.pow(f, t.length);
        for (var h: any = t.length - 1; h >= 0; h--, d /= f) {
            if (p >= d) {
        ...
        if (r) {
            var i: any = String(s.toExponential()).split("e-");
...
Dygraph.dateString_ = function(e) {
    var i: any = Dygraph.zeropad;
    var h: any = new Date(e);
    var f: any = "" + h.getFullYear();
    var g: any = i(h.getMonth() + 1);
    var a: any = i(h.getDate());
    var c: any = "";
    var b: any = h.getHours() * 3600 + h.getMinutes() * 60 + h.getSeconds();
    if (b) {
...
Dygraph.dateAxisFormatter = function(b, c) {
    if (c >= Dygraph.DECADAL) {
        ...
        if (c >= Dygraph.MONTHLY) {
            ...
            var a: any = b.getHours() * 3600 + b.getMinutes() * 60 + b.getSeconds() + b.getMilliseconds();
            if (a === 0 || c >= Dygraph.DAILY) {
                return (<any> new Date(b.getTime() + 3600 * 1000)).strftime("%d%b")
            } else {
...
Dygraph.prototype.__init__ = function(a, c, l) {
    if (/MSIE/.test(navigator.userAgent) && !(<any>window).opera && typeof(G_vmlCanvasManager) != "undefined" && (<any>document).readyState != "complete") {
        var o: any = this;
        setTimeout(function() {
            o.__init__(a, c, l)
        }, 100);
    ...
    if (typeof(a) == "string") {
        a = (<any>document).getElementById(a)
    }
    if (!a) {
    ...
    this.plugins_ = [];
    var d: any = Dygraph.PLUGINS.concat(this.getOption("plugins"));
    for (var g: any = 0; g < d.length; g++) {
        var k: any = d[g];
        var f: any = new k();
        var j: any = {
            plugin: f,
        ...
        var b: any = f.activate(this);
        for (var h in b) {
            j.events[h] = b[h]
        }
        this.plugins_.push(j)
    }
    for (var g: any = 0; g < this.plugins_.length; g++) {
        var n: any = this.plugins_[g];
        for (var h in n.events) {
            if (!n.events.hasOwnProperty(h)) {
                continue
            }
            var m: any = n.events[h];
            var e: any = [n.plugin, m];
...
Dygraph.prototype.cascadeEvents_ = function(c, b) {
    ...
    Dygraph.update(g, b);
    var a: any = this.eventListeners_[c];
    if (a) {
        for (var d: any = a.length - 1; d >= 0; d--) {
            var f: any = a[d][0];
            var h: any = a[d][1];
            h.call(f, g);
...
Dygraph.prototype.toString = function() {
    var a: any = this.maindiv_;
    var b: any = (a && a.id) ? a.id : a;
    return "[Dygraph " + b + "]"
};
...
Dygraph.prototype.xAxisExtremes = function() {
    var d: any = this.attr_("xRangePad") / this.plotter_.area.w;
    if (this.numRows() === 0) {
        return [0 - d, 1 + d]
    }
    var c: any = this.rawData_[0][0];
    var b: any = this.rawData_[this.rawData_.length - 1][0];
    if (d) {
        var a: any = b - c;
        c -= a * d;
        b += a * d
...
Dygraph.prototype.yAxisRange = function(a) {
    ...
    var b: any = this.axes_[a];
    return [b.computedValueRange[0], b.computedValueRange[1]]
};
Dygraph.prototype.yAxisRanges = function() {
    var a: any = [];
    for (var b: any = 0; b < this.axes_.length; b++) {
...
Dygraph.prototype.toDomXCoord = function(b) {
    ...
    var c: any = this.plotter_.area;
    var a: any = this.xAxisRange();
    return c.x + (b - a[0]) / (a[1] - a[0]) * c.w
};
Dygraph.prototype.toDomYCoord = function(d, a) {
    var c: any = this.toPercentYCoord(d, a);
    if (c === null) {
        return null
    }
    var b: any = this.plotter_.area;
    return b.y + c * b.h
};
...
Dygraph.prototype.toDataYCoord = function(h, b) {
    ...
    if (!this.axes_[b].logscale) {
        ...
        var f: any = (h - c.y) / c.h;
        var a: any = Dygraph.log10(g[1]);
        var e: any = a - (f * (a - Dygraph.log10(g[0])));
        var d: any = Math.pow(Dygraph.LOG_SCALE, e);
        return d
    }
};
Dygraph.prototype.toPercentYCoord = function(f, c) {
    ...
    var e: any = this.yAxisRange(c);
    var d: any;
    var b: any = this.attributes_.getForAxis("logscale", c);
    if (!b) {
        d = (e[1] - f) / (e[1] - e[0])
    } else {
        var a: any = Dygraph.log10(e[1]);
...
Dygraph.prototype.createInterface_ = function() {
    var a: any = this.maindiv_;
    this.graphDiv = (<any>document).createElement("div");
    ...
    this.mouseOutHandler_ = function(f) {
        var d: any = f.target || f.fromElement;
        var c: any = f.relatedTarget || f.toElement;
...
Dygraph.prototype.destroy = function() {
    ...
    if (this.registeredEvents_) {
        for (var a: any = 0; a < this.registeredEvents_.length; a++) {
            var d: any = this.registeredEvents_[a];
...
Dygraph.prototype.createPlotKitCanvas_ = function(a) {
    var b: any = Dygraph.createCanvas();
...
Dygraph.prototype.createMouseEventElement_ = function() {
    if (this.isUsingExcanvas_) {
        var a: any = (<any>document).createElement("div");
...
Dygraph.prototype.setColors_ = function() {
    var g: any = this.getLabels();
    var e: any = g.length - 1;
    this.colors_ = [];
    this.colorsMap_ = {};
    var a: any = this.attr_("colors");
    var d: any;
    if (!a) {
        var c: any = this.attr_("colorSaturation") || 1;
        var b: any = this.attr_("colorValue") || 0.5;
        var k: any = Math.ceil(e / 2);
        for (d = 1; d <= e; d++) {
            if (!this.visibility()[d - 1]) {
                continue
            }
            var h: any = d % 2 ? Math.ceil(d / 2) : (k + d / 2);
            var f: any = (1 * h / (1 + e));
            var j: any = Dygraph.hsvToRGB(f, c, b);
            this.colors_.push(j);
...
Dygraph.prototype.getPropertiesForSeries = function(c) {
    var a: any = -1;
    var d: any = this.getLabels();
    for (var b: any = 1; b < d.length; b++) {
        if (d[b] == c) {
            a = b;
            break
        }
...
Dygraph.prototype.createRollInterface_ = function() {
    if (!this.roller_) {
        this.roller_ = (<any>document).createElement("input");
        this.roller_.type = "text";
        this.roller_.style.display = "none";
        this.graphDiv.appendChild(this.roller_)
    }
    var e: any = this.attr_("showRoller") ? "block" : "none";
    var d: any = this.plotter_.area;
    var b: any = {
        position: "absolute",
        zIndex: 10,
        top: (d.y + d.h - 25) + "px",
...
Dygraph.prototype.createDragInterface_ = function() {
    ...
    var e: any = this.attr_("interactionModel");
    var b: any = this;
    var d: any = function(f) {
        return function(g) {
            f(g, b, c)
        }
    };
    ...
    this.mouseUpHandler_ = function(g) {
        ...
        if (c.isPanning) {
            ...
            c.draggingDate = null;
            c.dateRange = null;
            for (var f: any = 0; f < b.axes_.length; f++) {
...
Dygraph.prototype.doZoomX_ = function(c, a) {
    this.currentZoomRectArgs_ = null;
    var b: any = this.toDataXCoord(c);
    var d: any = this.toDataXCoord(a);
...
Dygraph.prototype.doZoomY_ = function(h, f) {
    this.currentZoomRectArgs_ = null;
    var c: any = this.yAxisRanges();
    var b: any = [];
    for (var e: any = 0; e < this.axes_.length; e++) {
        var d: any = this.toDataYCoord(h, e);
        var a: any = this.toDataYCoord(f, e);
        b.push([a, d])
    }
    this.zoomed_y_ = true;
    var g: any = this;
...
Dygraph.prototype.resetZoom = function() {
    ...
    for (var g: any = 0; g < this.axes_.length; g++) {
    ...
    if (c) {
        ...
        if (a) {
            k = this.yAxisRanges();
            var n: any = this.gatherDatasets_(this.rolledSeries_, null);
            var o: any = n[1];
            this.computeYAxisRanges_(o);
            h = [];
            for (g = 0; g < this.axes_.length; g++) {
                var e: any = this.axes_[g];
        ...
        this.doAnimatedZoom(l, m, k, h, function() {
            j.dateWindow_ = null;
            for (var p: any = 0; p < j.axes_.length; p++) {
...
Dygraph.prototype.doAnimatedZoom = function(a, e, b, c, m) {
    var i: any = this.attr_("animatedZooms") ? Dygraph.ANIMATION_STEPS : 1;
    var l: any = [];
    var k: any = [];
    var f, d;
    if (a !== null && e !== null) {
    ...
    Dygraph.repeatAndCleanup(function(p) {
        if (k.length) {
            for (var o: any = 0; o < h.axes_.length; o++) {
                var j: any = k[p][o];
...
Dygraph.prototype.eventToDomCoords = function(c) {
    if (c.offsetX && c.offsetY) {
        ...
        var b: any = Dygraph.pageX(c) - Dygraph.findPosX(this.mouseEventElement_);
        var a: any = Dygraph.pageY(c) - Dygraph.findPosY(this.mouseEventElement_);
        return [b, a]
    }
};
Dygraph.prototype.findClosestRow = function(b) {
    ...
    var d: any = -1,
        a = -1;
    var g: any = this.layout_.points;
    for (var e: any = 0; e < g.length; e++) {
        var m: any = g[e];
        var f: any = m.length;
        for (var c: any = 0; c < f; c++) {
            var l: any = m[c];
            if (!Dygraph.isValidPoint(l, true)) {
                continue
            }
            var h: any = Math.abs(l.canvasx - b);
            if (h < k) {
                k = h;
                a = e;
                d = c
...
Dygraph.prototype.findClosestPoint = function(f, e) {
    ...
    var k: any = -1;
    var h, o, n, l, d, c;
    for (var b: any = this.layout_.datasets.length - 1; b >= 0; --b) {
        var m: any = this.layout_.points[b];
        for (var g: any = 0; g < m.length; ++g) {
            var l: any = m[g];
    ...
    var a: any = this.layout_.setNames[c];
    return {
...
Dygraph.prototype.findStackedPoint = function(i, h) {
    var p: any = this.findClosestRow(i);
    var g: any = this.getLeftBoundary_();
    var e: any = p - g;
    var f, c;
    for (var d: any = 0; d < this.layout_.datasets.length; ++d) {
        var l: any = this.layout_.points[d];
        if (e >= l.length) {
            continue
        }
        var m: any = l[e];
        ...
        if (i > m.canvasx && e + 1 < l.length) {
            ...
            if (Dygraph.isValidPoint(k)) {
                var o: any = k.canvasx - m.canvasx;
                if (o > 0) {
                    var a: any = (i - m.canvasx) / o;
            ...
            if (i < m.canvasx && e > 0) {
                ...
                if (Dygraph.isValidPoint(n)) {
                    var o: any = m.canvasx - n.canvasx;
                    if (o > 0) {
                        var a: any = (m.canvasx - i) / o;
    ...
    var b: any = this.layout_.setNames[c];
    return {
        row: p,
        seriesName: b,
        point: f
...
Dygraph.prototype.mouseMove_ = function(b) {
    var h: any = this.layout_.points;
    if (h === undefined || h === null) {
        return
    }
    var e: any = this.eventToDomCoords(b);
    var a: any = e[0];
    var j: any = e[1];
    var f: any = this.attr_("highlightSeriesOpts");
    var d: any = false;
    if (f && !this.isSeriesLocked()) {
        ...
        var g: any = this.findClosestRow(a);
        d = this.setSelection(g)
    }
    var i: any = this.attr_("highlightCallback");
    if (i && d) {
...
Dygraph.prototype.getLeftBoundary_ = function() {
    for (var a: any = 0; a < this.boundaryIds_.length; a++) {
...
Dygraph.prototype.idxToRow_ = function(b, a) {
    ...
    var c: any = this.getLeftBoundary_();
    return c + a
};
...
Dygraph.prototype.updateSelection_ = function(d) {
    ...
    var h: any;
    var n: any = this.canvas_ctx_;
    if (this.attr_("highlightSeriesOpts")) {
        n.clearRect(0, 0, this.width_, this.height_);
        var f: any = 1 - this.attr_("highlightSeriesBackgroundAlpha");
        if (f) {
            var g: any = true;
            if (g) {
                if (d === undefined) {
        ...
        if (this.previousVerticalX_ >= 0) {
            var j: any = 0;
            var k: any = this.attr_("labels");
            for (h = 1; h < k.length; h++) {
                var c: any = this.attr_("highlightCircleSize", k[h]);
                if (c > j) {
                    j = c
                }
            }
            var l: any = this.previousVerticalX_;
    ...
    if (this.selPoints_.length > 0) {
        var b: any = this.selPoints_[0].canvasx;
        n.save();
        for (h = 0; h < this.selPoints_.length; h++) {
            var o: any = this.selPoints_[h];
            if (!Dygraph.isOK(o.canvasy)) {
                continue
            }
            var a: any = this.attr_("highlightCircleSize", o.name);
            var m: any = this.attr_("drawHighlightPointCallback", o.name);
            var e: any = this.plotter_.colors[o.name];
            if (!m) {
...
Dygraph.prototype.setSelection = function(d, g, f) {
    ...
    if (d !== false && d >= 0) {
        ...
        this.lastRow_ = d;
        for (var b: any = 0; b < this.layout_.datasets.length; ++b) {
            var e: any = this.layout_.datasets[b];
            if (d < e.length) {
                var a: any = this.layout_.points[b][d];
                if (this.attr_("stackedGraph")) {
...
Dygraph.prototype.getSelection = function() {
    ...
    for (var c: any = 0; c < this.layout_.points.length; c++) {
        var a: any = this.layout_.points[c];
        for (var b: any = 0; b < a.length; b++) {
...
Dygraph.prototype.addXTicks_ = function() {
    ...
    var c: any = this.optionsViewForAxis_("x");
    var b: any = c("ticker")(a[0], a[1], this.width_, c, this);
...
Dygraph.prototype.extremeValues_ = function(d) {
    var h: any = null,
        f = null,
        c, g;
    var b: any = this.attr_("errorBars") || this.attr_("customBars");
    if (b) {
...
Dygraph.prototype.predraw_ = function() {
    ...
    for (var c: any = 1; c < this.numColumns(); c++) {
        var d: any = this.attr_("logscale");
        var b: any = this.extractSeries_(this.rawData_, c, d);
...
Dygraph.prototype.gatherDatasets_ = function(v, d) {
    ...
    for (t = m; t >= 1; t--) {
        ...
        var o: any = this.attr_("errorBars") || this.attr_("customBars");
        if (d) {
            var z: any = d[0];
            var g: any = d[1];
            var p: any = [];
        ...
        var n: any = this.extremeValues_(l);
        if (o) {
...
Dygraph.prototype.drawGraph_ = function() {
    var a: any = new Date();
    var e: any = this.is_initial_draw_;
    this.is_initial_draw_ = false;
    this.layout_.removeAllDatasets();
    this.setColors_();
    this.attrs_.pointSize = 0.5 * this.attr_("highlightCircleSize");
    var j: any = this.gatherDatasets_(this.rolledSeries_, this.dateWindow_);
    var d: any = j[0];
    var k: any = j[1];
    this.boundaryIds_ = j[2];
    this.setIndexByName_ = {};
    var h: any = this.attr_("labels");
    if (h.length > 0) {
        this.setIndexByName_[h[0]] = 0
    }
    var f: any = 0;
    for (var g: any = 1; g < d.length; g++) {
...
Dygraph.prototype.computeYAxes_ = function() {
    ...
    if (b !== undefined) {
        var e: any = Math.min(b.length, this.axes_.length);
        for (c = 0; c < e; c++) {
    ...
    for (d = 0; d < this.axes_.length; d++) {
        if (d === 0) {
            ...
            var g: any = this.user_attrs_.axes;
            if (g && g.y2) {
                a = g.y2.valueRange;
                if (a) {
                    this.axes_[d].valueRange = a
...
Dygraph.prototype.computeYAxisRanges_ = function(a) {
    var g: any = function(i) {
        return isNaN(parseFloat(i))
    };
    var p: any = this.attributes_.numAxes();
    var b, w, n, A;
    for (var x: any = 0; x < p; x++) {
        var c: any = this.axes_[x];
        var B: any = this.attributes_.getForAxis("logscale", x);
        var F: any = this.attributes_.getForAxis("includeZero", x);
        ...
        if (n.length === 0) {
            ...
            if (B) {
                if (b) {
                    ...
                    var D: any = Math.exp(Math.log(w) * A);
                    h = z * D;
                    G = C / D
                }
            } else {
        ...
        if (c.valueWindow) {
            ...
            if (c.valueRange) {
                var e: any = g(c.valueRange[0]) ? c.extremeRange[0] : c.valueRange[0];
                var d: any = g(c.valueRange[1]) ? c.extremeRange[1] : c.valueRange[1];
                if (!b) {
                    if (c.logscale) {
                        var D: any = Math.exp(Math.log(w) * A);
                        e *= D;
        ...
        var q: any = this.optionsViewForAxis_("y" + (x ? "2" : ""));
        var E: any = q("ticker");
        if (x === 0 || c.independentTicks) {
            c.ticks = E(c.computedValueRange[0], c.computedValueRange[1], this.height_, q, this)
        } else {
            var o: any = this.axes_[0];
            var l: any = o.ticks;
            var m: any = o.computedValueRange[1] - o.computedValueRange[0];
            var H: any = c.computedValueRange[1] - c.computedValueRange[0];
            var f: any = [];
            for (var u: any = 0; u < l.length; u++) {
                var t: any = (l[u].v - o.computedValueRange[0]) / m;
                var y: any = c.computedValueRange[0] + t * H;
                f.push(y)
            }
...
Dygraph.prototype.extractSeries_ = function(a, e, b) {
    var f: any = [];
    var g: any = this.attr_("errorBars");
    var d: any = this.attr_("customBars");
    for (var c: any = 0; c < a.length; c++) {
        var h: any = a[c][0];
        var k: any = a[c][e];
        if (b) {
            if (k <= 0) {
            ...
            if (this.attr_("errorBars")) {
                if (this.attr_("wilsonInterval")) {
                    if (h) {
                        var s: any = w < 0 ? 0 : w,
                            u = h;
                        var B: any = t * Math.sqrt(s * (1 - s) / u + t * t / (4 * u * u));
                        var a: any = 1 + t * t / h;
                        G = (s + t * t / (2 * h) - B) / a;
                        o = (s + t * t / (2 * h) + B) / a;
...
Dygraph.prototype.parseFloat_ = function(a, c, b) {
    ...
    var d: any = "Unable to parse '" + a + "' as a number";
    if (b !== null && c !== null) {
...
Dygraph.prototype.parseCSV_ = function(t) {
    var r: any = [];
    var s: any = Dygraph.detectLineDelimiter(t);
    var a: any = t.split(s || "\n");
    var g, k;
    var p: any = this.attr_("delimiter");
    ...
    var m: any;
    var q: any = false;
    var c: any = this.attr_("labels").length;
    var f: any = false;
    for (var l: any = b; l < a.length; l++) {
        var e: any = a[l];
        o = l;
        if (e.length === 0) {
            continue
...
Dygraph.prototype.parseDataTable_ = function(w) {
    var d: any = function(i) {
        var j: any = String.fromCharCode(65 + i % 26);
        i = Math.floor(i / 26);
        while (i > 0) {
    ...
    var h: any = w.getNumberOfColumns();
    var g: any = w.getNumberOfRows();
    var f: any = w.getColumnType(0);
    ...
    var q, o;
    for (q = 1; q < h; q++) {
        var b: any = w.getColumnType(q);
        if (b == "number") {
            m.push(q)
        } else {
            if (b == "string" && this.attr_("displayAnnotations")) {
                var r: any = m[m.length - 1];
        ...
        if (!this.attr_("errorBars")) {
            for (o = 0; o < m.length; o++) {
                ...
                if (s && t.hasOwnProperty(c) && w.getValue(q, t[c][0]) !== null) {
                    ...
                    p.text = "";
                    for (var n: any = 0; n < t[c].length; n++) {
                        if (n) {
                            p.text += "\n"
                        }
...
Dygraph.prototype.start_ = function() {
    ...
    if (Dygraph.isArrayLike(d)) {
        ...
        if (typeof d == "object" && typeof d.getColumnRange == "function") {
            ...
            if (typeof d == "string") {
                var c: any = Dygraph.detectLineDelimiter(d);
                if (c) {
                    this.loadedEvent_(d)
                } else {
                    var b: any = new XMLHttpRequest();
                    var a: any = this;
...
Dygraph.prototype.updateOptions = function(e, b) {
    ...
    var d: any = e.file;
    var c: any = Dygraph.mapLegacyOptions_(e);
    if ("rollPeriod" in c) {
    ...
    var a: any = Dygraph.isPixelChangingOptionList(this.attr_("labels"), c);
...
Dygraph.prototype.resize = function(d, b) {
    ...
    var a: any = this.width_;
    var c: any = this.height_;
    if (d) {
...
Dygraph.addAnnotationRule = function() {
    ...
    var f: any = "border: 1px solid black; background-color: white; text-align: center;";
    var e: any = (<any>document).createElement("style");
    e.type = "text/css";
    (<any>document).getElementsByTagName("head")[0].appendChild(e);
    for (var b: any = 0; b < (<any>document).styleSheets.length; b++) {
        if ((<any>document).styleSheets[b].disabled) {
            continue
        }
        var d: any = (<any>document).styleSheets[b];
        try {
            if (d.insertRule) {
                var a: any = d.cssRules ? d.cssRules.length : 0;
...
Dygraph.log = function(c, g) {
    ...
    if (typeof(printStackTrace) != "undefined") {
        try {
            ...
            b.splice(0, 2);
            for (var d: any = 0; d < b.length; d++) {
                b[d] = b[d].replace(/\([^)]*\/(.*)\)/, "@$1").replace(/\@.*\/([^\/]*)/, "@$1").replace("[object Object].", "")
            }
            var j: any = b.splice(0, 1)[0];
            g += " (" + j.replace(/^.*@ ?/, "") + ")"
        } catch (h) {}
    }
    if (typeof((<any>window).console) != "undefined") {
        var a: any = (<any>window).console;
        var f: any = function(e, k, i) {
    ...
    if (c.offsetParent) {
        ...
        while (1) {
            ...
            if ((<any>window).getComputedStyle) {
                b = (<any>window).getComputedStyle(a, null).borderLeft || "0"
            }
            d += parseInt(b, 10);
            d += a.offsetLeft;
            if (!a.offsetParent) {
...
Dygraph.findPosY = function(c) {
    ...
    if (c.offsetParent) {
        ...
        while (1) {
            var d: any = "0";
            if ((<any>window).getComputedStyle) {
                d = (<any>window).getComputedStyle(a, null).borderTop || "0"
            }
            b += parseInt(d, 10);
            b += a.offsetTop;
            if (!a.offsetParent) {
...
Dygraph.pageX = function(c) {
    if (c.pageX) {
        ...
        var d: any = (<any>document).documentElement;
        var a: any = (<any>document).body;
...
Dygraph.floatFormat = function(a, b) {
    var c: any = Math.min(Math.max(1, b || 2), 21);
...
Dygraph.binarySearch = function(a, d, i, e, b) {
    ...
    var h: any = function(j) {
        return j >= 0 && j < d.length
    };
    var g: any = parseInt(((e + b) / 2).toString(), 10);
    var c: any = d[g];
    var f: any;
    if (c == a) {
        return g
...
Dygraph.createCanvas = function() {
    var a: any = (<any>document).createElement("canvas");
    var b: any = (/MSIE/.test(navigator.userAgent) && !(<any>window).opera);
...
Dygraph.requestAnimFrame = (function() {
    return (<any>window).requestAnimationFrame || (<any>window).webkitRequestAnimationFrame || (<any>window).mozRequestAnimationFrame || (<any>window).oRequestAnimationFrame || (<any>window).msRequestAnimationFrame || function(a) {
        (<any>window).setTimeout(a, 1000 / 60)
    }
})();
Dygraph.repeatAndCleanup = function(h, g, f, a) {
    var i: any = 0;
    var d: any;
    var b: any = new Date().getTime();
    h(i);
    if (g == 1) {
        a();
        return
...
Dygraph.regularShape_ = function(o, c, i, f, e, a, n) {
    ...
    var d: any = g;
    var h: any = function() {
        var p: any = f + (Math.sin(d) * i);
        var q: any = e + (-Math.cos(d) * i);
        return [p, q]
    };
    var b: any = h();
    var l: any = b[0];
...
Dygraph.IFrameTarp.prototype.cover = function() {
    var f: any = (<any>document).getElementsByTagName("iframe");
    for (var c: any = 0; c < f.length; c++) {
        var e: any = f[c];
        var b: any = Dygraph.findPosX(e),
            h = Dygraph.findPosY(e),
            d = e.offsetWidth,
            a = e.offsetHeight;
        var g: any = (<any>document).createElement("div");
        ...
        g.style.height = a + "px";
        g.style.zIndex = 999;
        (<any>document).body.appendChild(g);
        this.tarps.push(g)
    }
};
Dygraph.IFrameTarp.prototype.uncover = function() {
    for (var a: any = 0; a < this.tarps.length; a++) {
...
Dygraph.dateSetters = {
    ms: (<any>Date).prototype.setMilliseconds,
    s: (<any>Date).prototype.setSeconds,
    m: (<any>Date).prototype.setMinutes,
    h: (<any>Date).prototype.setHours
};
Dygraph.setDateSameTZ = function(c, b) {
    var f: any = c.getTimezoneOffset();
    for (var a in b) {
        if (!b.hasOwnProperty(a)) {
            continue
        }
        var e: any = Dygraph.dateSetters[a];
        if (!e) {
...
Dygraph.GVizChart.prototype.getSelection = function() {
    var b: any = [];
    var d: any = this.date_graph.getSelection();
    if (d < 0) {
        return b
    }
    var a: any = this.date_graph.layout_.datasets;
    for (var c: any = 0; c < a.length; ++c) {
        b.push({
            row: d,
            column: c + 1
...
Dygraph.Interaction.startPan = function(o, t, c) {
    var r, b;
    c.isPanning = true;
    var k: any = t.xAxisRange();
    c.dateRange = k[1] - k[0];
    c.initialLeftmostDate = k[0];
    c.xUnitsPerPixel = c.dateRange / (t.plotter_.area.w - 1);
    if (t.attr_("panEdgeFraction")) {
        var x: any = t.width_ * t.attr_("panEdgeFraction");
        var d: any = t.xAxisExtremes();
        var j: any = t.toDomXCoord(d[0]) - x;
        var l: any = t.toDomXCoord(d[1]) + x;
        var u: any = t.toDataXCoord(j);
        var w: any = t.toDataXCoord(l);
        c.boundedDates = [u, w];
        var f: any = [];
        var a: any = t.height_ * t.attr_("panEdgeFraction");
        for (r = 0; r < t.axes_.length; r++) {
            b = t.axes_[r];
            var p: any = b.extremeRange;
            var q: any = t.toDomYCoord(p[0], r) + a;
            var s: any = t.toDomYCoord(p[1], r) - a;
            var n: any = t.toDataYCoord(q, r);
            var e: any = t.toDataYCoord(s, r);
            f[r] = [n, e]
        }
        c.boundedValues = f
    }
    ...
    for (r = 0; r < t.axes_.length; r++) {
        b = t.axes_[r];
        var h: any = {};
        var m: any = t.yAxisRange(r);
        var v: any = t.attributes_.getForAxis("logscale", r);
        if (v) {
...
Dygraph.Interaction.movePan = function(b, k, c) {
    ...
    var h: any = c.initialLeftmostDate - (c.dragEndX - c.dragStartX) * c.xUnitsPerPixel;
    if (c.boundedDates) {
        h = Math.max(h, c.boundedDates[0])
    }
    var a: any = h + c.dateRange;
    if (c.boundedDates) {
    ...
    k.dateWindow_ = [h, a];
    if (c.is2DPan) {
        var d: any = c.dragEndY - c.dragStartY;
        for (var j: any = 0; j < k.axes_.length; j++) {
            var e: any = k.axes_[j];
            var o: any = c.axes[j];
            var p: any = d * o.unitsPerPixel;
            var f: any = c.boundedValues ? c.boundedValues[j] : null;
            var l: any = o.initialTopValue + p;
            if (f) {
                l = Math.min(l, f[1])
            }
            var n: any = l - o.dragValueRange;
            if (f) {
                if (n < f[0]) {
                    l = l - (n - f[0]);
            ...
            var m: any = k.attributes_.getForAxis("logscale", j);
            if (m) {
...
Dygraph.Interaction.endPan = function(c, b, a) {
    ...
    var e: any = Math.abs(a.dragEndX - a.dragStartX);
    var d: any = Math.abs(a.dragEndY - a.dragStartY);
...
Dygraph.Interaction.moveZoom = function(c, b, a) {
    ...
    a.dragEndX = b.dragGetX_(c, a);
    a.dragEndY = b.dragGetY_(c, a);
    var e: any = Math.abs(a.dragStartX - a.dragEndX);
    var d: any = Math.abs(a.dragStartY - a.dragEndY);
...
Dygraph.Interaction.treatMouseOpAsClick = function(f, b, d) {
    var k: any = f.attr_("clickCallback");
    var n: any = f.attr_("pointClickCallback");
    var j: any = null;
    if (n) {
        var l: any = -1;
        var m: any = Number.MAX_VALUE;
        for (var e: any = 0; e < f.selPoints_.length; e++) {
            var c: any = f.selPoints_[e];
            var a: any = Math.pow(c.canvasx - d.dragEndX, 2) + Math.pow(c.canvasy - d.dragEndY, 2);
            if (!isNaN(a) && (l == -1 || a < m)) {
                m = a;
                l = e
            }
        }
        var h: any = f.attr_("highlightCircleSize") + 2;
        if (m <= h * h) {
            j = f.selPoints_[l]
        }
    }
...
Dygraph.Interaction.endZoom = function(c, i, e) {
    ...
    var h: any = Math.abs(e.dragEndX - e.dragStartX);
    var d: any = Math.abs(e.dragEndY - e.dragStartY);
    ...
    if (h >= 10 && e.dragDirection == Dygraph.HORIZONTAL) {
        var f: any = Math.min(e.dragStartX, e.dragEndX),
        ...
        if (d >= 10 && e.dragDirection == Dygraph.VERTICAL) {
            var j: any = Math.min(e.dragStartY, e.dragEndY),
...
Dygraph.Interaction.startTouch = function(f, e, d) {
    ...
    var h: any = [];
    for (var c: any = 0; c < f.touches.length; c++) {
        var b: any = f.touches[c];
        h.push({
            pageX: b.pageX,
            pageY: b.pageY,
    ...
    if (h.length == 1) {
        ...
        if (h.length >= 2) {
            ...
            var a: any = 180 / Math.PI * Math.atan2(d.initialPinchCenter.pageY - h[0].pageY, h[0].pageX - d.initialPinchCenter.pageX);
            a = Math.abs(a);
            if (a > 90) {
                a = 90 - a
            }
...
Dygraph.Interaction.moveTouch = function(n, q, d) {
    ...
    for (p = 0; p < n.touches.length; p++) {
        var k: any = n.touches[p];
        l.push({
            pageX: k.pageX,
            pageY: k.pageY
        })
    }
    var a: any = d.initialTouches;
    var h: any;
    var j: any = d.initialPinchCenter;
    if (l.length == 1) {
        h = l[0]
    } else {
        h = {
    ...
    var f: any = d.initialRange.x[1] - d.initialRange.x[0];
    var o: any = d.initialRange.y[0] - d.initialRange.y[1];
    ...
    if (l.length == 1) {
        ...
        if (l.length >= 2) {
            var e: any = (a[1].pageX - j.pageX);
            w = (l[1].pageX - h.pageX) / e;
            var v: any = (a[1].pageY - j.pageY);
    ...
    if (d.touchDirections.y) {
        for (p = 0; p < 1; p++) {
            var b: any = q.axes_[p];
            var s: any = q.attributes_.getForAxis("logscale", p);
            if (s) {} else {
...
Dygraph.Interaction.endTouch = function(e, d, c) {
    if (e.touches.length !== 0) {
        ...
        if (e.changedTouches.length == 1) {
            var a: any = new Date().getTime();
            var b: any = e.changedTouches[0];
...
Dygraph.numericTicks = function(F, E, u, p, d, q) {
    ...
    if (q) {
        ...
        if (p("logscale")) {
            y = Math.floor(u / z);
            var l: any = Dygraph.binarySearch(F, Dygraph.PREFERRED_LOG_TICK_VALUES, 1);
            var H: any = Dygraph.binarySearch(E, Dygraph.PREFERRED_LOG_TICK_VALUES, -1);
            if (l == -1) {
                l = 0
            }
            if (H == -1) {
            ...
            var s: any = null;
            if (H - l >= y / 4) {
                for (var r: any = H; r >= l; r--) {
                    var m: any = Dygraph.PREFERRED_LOG_TICK_VALUES[r];
                    var k: any = Math.log(m / F) / Math.log(E / F) * u;
                    var D: any = {
                        v: m
                    };
                    if (s === null) {
        ...
        if (G.length === 0) {
            ...
            var w: any = Math.ceil(u / z);
            var o: any = Math.abs(E - F) / w;
            var v: any = Math.floor(Math.log(o) / Math.log(h));
            var f: any = Math.pow(h, v);
            var I, x, c, e;
    ...
    var B: any = (p("axisLabelFormatter"));
...
Dygraph.dateTicker = function(e, c, i, g, f, h) {
    var d: any = Dygraph.pickDateTickGranularity(e, c, i, g);
    if (d >= 0) {
...
Dygraph.PREFERRED_LOG_TICK_VALUES = function() {
    var c: any = [];
    for (var b: any = -39; b <= 39; b++) {
        var a: any = Math.pow(10, b);
        for (var d: any = 1; d <= 9; d++) {
            var e: any = a * d;
            c.push(e)
        }
    }
...
Dygraph.pickDateTickGranularity = function(d, c, j, h) {
    var g: any = (h("pixelsPerLabel"));
    for (var f: any = 0; f < Dygraph.NUM_GRANULARITIES; f++) {
        var e: any = Dygraph.numDateTicks(d, c, f);
        if (j / e >= g) {
            return f
        }
    }
...
Dygraph.numDateTicks = function(e, b, f) {
    if (f < Dygraph.MONTHLY) {
        var g: any = Dygraph.SHORT_SPACINGS[f];
        return Math.floor(0.5 + 1 * (b - e) / g)
    } else {
        var d: any = Dygraph.LONG_TICK_PLACEMENTS[f];
        var c: any = 365.2524 * 24 * 3600 * 1000;
        var a: any = 1 * (b - e) / c;
        return Math.floor(0.5 + 1 * a * d.months.length / d.year_mod)
    }
};
Dygraph.getDateAxis = function(p, l, a, n, z) {
    var w: any = (n("axisLabelFormatter"));
    var C: any = [];
    var m: any;
    if (a < Dygraph.MONTHLY) {
        var c: any = Dygraph.SHORT_SPACINGS[a];
        var y: any = c / 1000;
        var A: any = new Date(p);
        ...
        p = A.getTime();
        var B: any = new Date(p).getTimezoneOffset();
        var e: any = (c >= Dygraph.SHORT_SPACINGS[Dygraph.TWO_HOURLY]);
        for (m = p; m <= l; m += c) {
            A = new Date(m);
            if (e && A.getTimezoneOffset() != B) {
                var k: any = A.getTimezoneOffset() - B;
                m += k * 60 * 1000;
                A = new Date(m);
        ...
        var v: any = new Date(p).getFullYear();
        var q: any = new Date(l).getFullYear();
        var b: any = Dygraph.zeropad;
        for (var u: any = v; u <= q; u++) {
            if (u % r !== 0) {
                continue
            }
            for (var s: any = 0; s < f.length; s++) {
                var o: any = u + "/" + b(1 + f[s]) + "/01";
...
Dygraph.Plugins.Annotations = (function() {
    ...
    a.prototype.detachLabels = function() {
        for (var c: any = 0; c < this.annotations_.length; c++) {
            var b: any = this.annotations_[c];
            if (b.parentNode) {
    ...
    a.prototype.didDrawChart = function(v) {
        var t: any = v.dygraph;
        var r: any = t.layout_.annotated_points;
        if (!r || r.length === 0) {
            return
        }
        var h: any = v.canvas.parentNode;
        var x: any = {
            position: "absolute",
        ...
        var b: any = function(e, g, i) {
            return function(y) {
                var p: any = i.annotation;
        ...
        var u: any = v.dygraph.plotter_.area;
        var q: any = {};
        for (var s: any = 0; s < r.length; s++) {
            var l: any = r[s];
            if (l.canvasx < u.x || l.canvasx > u.x + u.w || l.canvasy < u.y || l.canvasy > u.y + u.h) {
                continue
            }
            var w: any = l.annotation;
            var n: any = 6;
            if (w.hasOwnProperty("tickHeight")) {
                n = w.tickHeight
            }
            var j: any = (<any>document).createElement("div");
            for (var A in x) {
            ...
            var m: any = w.hasOwnProperty("width") ? w.width : 16;
            var k: any = w.hasOwnProperty("height") ? w.height : 16;
            if (w.hasOwnProperty("icon")) {
                var z: any = (<any>document).createElement("img");
                z.src = w.icon;
                z.width = m;
                z.height = k;
                j.appendChild(z)
                ...
                if (l.annotation.hasOwnProperty("shortText")) {
                    j.appendChild((<any>document).createTextNode(l.annotation.shortText))
                }
            }
            var c: any = l.canvasx - m / 2;
            j.style.left = c + "px";
            var f: any = 0;
            if (w.attachAtBottom) {
                var d: any = (u.y + u.h - k - n);
                if (q[c]) {
                    d -= q[c]
                } else {
                    q[c] = 0
...
Dygraph.Plugins.Axes = (function() {
    ...
    a.prototype.layout = function(f) {
        ...
        if (d.getOption("drawYAxis")) {
            var b: any = d.getOption("yAxisLabelWidth") + 2 * d.getOption("axisTickSize");
    ...
    a.prototype.willDrawChart = function(H) {
        ...
        var j: any = H.drawingContext;
        var v: any = H.canvas.parentNode;
        var J: any = H.canvas.width;
        var d: any = H.canvas.height;
        var s, u, t, E, D;
        var C: any = function(e) {
            return {
                position: "absolute",
        ...
        var m: any = function(g, x, y) {
            var K: any = (<any>document).createElement("div");
            var e: any = p[y == "y2" ? "y2" : x];
            for (var r in e) {
        ...
        j.save();
        var I: any = F.layout_;
        var G: any = H.dygraph.plotter_.area;
        if (F.getOption("drawYAxis")) {
            if (I.yticks && I.yticks.length > 0) {
                ...
                for (D = 0; D < I.yticks.length; D++) {
                    ...
                    var k: any = F.getOptionForAxis("axisLabelFontSize", f);
                    t = G.y + E[1] * G.h;
                ...
                var n: any = this.ylabels_[0];
                var k: any = F.getOptionForAxis("axisLabelFontSize", "y");
                var q: any = parseInt(n.style.top, 10) + k;
                if (q > d - k) {
        ...
        if (F.getOption("drawXAxis")) {
            if (I.xticks) {
                for (D = 0; D < I.xticks.length; D++) {
                    ...
                    var l: any = (u - F.getOption("axisLabelWidth") / 2);
            ...
            var b: any;
            if (F.getOption("drawAxesAtZero")) {
                var w: any = F.toPercentYCoord(0, 0);
                if (w > 1 || w < 0) {
                    w = 1
                }
                b = A(G.y + w * G.h)
...
Dygraph.Plugins.ChartLabels = (function() {
    ...
    var b: any = function(d) {
        var e: any = (<any>document).createElement("div");
    ...
    c.prototype.detachLabels_ = function() {
        var e: any = [this.title_div_, this.xlabel_div_, this.ylabel_div_, this.y2label_div_];
        for (var d: any = 0; d < e.length; d++) {
            var f: any = e[d];
            if (!f) {
                continue
            }
    ...
    var a: any = function(l, i, f, h, j) {
        var d: any = (<any>document).createElement("div");
        ...
        var m: any = (<any>document).createElement("div");
        ...
        var e: any = "rotate(" + (f == 1 ? "-" : "") + "90deg)";
        m.style.transform = e;
        m.style.WebkitTransform = e;
        m.style.MozTransform = e;
        m.style.OTransform = e;
        m.style.msTransform = e;
        if (typeof((<any>document).documentMode) !== "undefined" && (<any>document).documentMode < 9) {
    ...
    c.prototype.layout = function(k) {
        this.detachLabels_();
        var i: any = k.dygraph;
        var m: any = k.chart_div;
        if (i.getOption("title")) {
            var d: any = k.reserveSpaceTop(i.getOption("titleHeight"));
            this.title_div_ = b(d);
            ...
            var f: any = (<any>document).createElement("div");
        ...
        if (i.getOption("xlabel")) {
            var j: any = k.reserveSpaceBottom(i.getOption("xLabelHeight"));
        ...
        if (i.getOption("ylabel")) {
            var h: any = k.reserveSpaceLeft(0);
        ...
        if (i.getOption("y2label") && i.numAxes() == 2) {
            var l: any = k.reserveSpaceRight(0);
...
Dygraph.Plugins.Grid = (function() {
    ...
    a.prototype.willDrawChart = function(k) {
        var h: any = k.dygraph;
        var o: any = k.drawingContext;
        var j: any = h.layout_;
        var c: any = k.dygraph.plotter_.area;
...
Dygraph.Plugins.Legend = (function() {
    ...
    c.prototype.activate = function(j) {
        var m: any;
        var f: any = j.getOption("labelsDivWidth");
        var l: any = j.getOption("labelsDiv");
        if (l && null !== l) {
            if (typeof(l) == "string" || l instanceof String) {
                m = (<any>document).getElementById(l)
            } else {
                m = l
            }
        } else {
            ...
            m = (<any>document).createElement("div");
    ...
    var b: any = function(g) {
        var f: any = (<any>document).createElement("span");
        f.setAttribute("style", "margin: 0; padding: 0 0 0 1em; border: 0;");
        g.appendChild(f);
        var e: any = f.offsetWidth;
        g.removeChild(f);
        return e
    };
    c.prototype.select = function(i) {
        var h: any = i.selectedX;
        var g: any = i.selectedPoints;
        var f: any = a(i.dygraph, h, g, this.one_em_width_);
        this.legend_div_.innerHTML = f
    };
    c.prototype.deselect = function(h) {
        var f: any = b(this.legend_div_);
        this.one_em_width_ = f;
        var g: any = a(h.dygraph, undefined, undefined, f);
    ...
    c.prototype.predraw = function(h) {
        ...
        var g: any = h.dygraph.plotter_.area;
        var f: any = h.dygraph.getOption("labelsDivWidth");
    ...
    a = function(w, p, l, f) {
        ...
        if (typeof(p) === "undefined") {
            ...
            for (u = 1; u < z.length; u++) {
                var q: any = w.getPropertiesForSeries(z[u]);
                if (!q.visible) {
                    continue
                }
                if (r !== "") {
        ...
        var A: any = w.optionsViewForAxis_("x");
        var o: any = A("valueFormatter");
        r = o(p, A, z[0], w);
        if (r !== "") {
            r += ":"
        }
        ...
        var k: any = w.getOption("labelsShowZeroValues");
        C = w.getOption("labelsSeparateLines");
        var B: any = w.getHighlightSeries();
        for (u = 0; u < l.length; u++) {
            ...
            var q: any = w.getPropertiesForSeries(t.name);
            var n: any = v[q.axis - 1];
            var y: any = n("valueFormatter");
            var e: any = y(t.yval, n, t.name, w);
            var h: any = (t.name == B) ? " class='highlight'" : "";
            r += "<span" + h + "> <b><span style='color: " + q.color + ";'>" + t.name + "</span></b>:&nbsp;" + e + "</span>"
        }
        return r
    };
    d = function(s, h, r) {
        var e: any = (/MSIE/.test(navigator.userAgent) && !(<any>window).opera);
        if (e) {
            return "&mdash;"
        }
        if (!s || s.length <= 1) {
...
Dygraph.Plugins.RangeSelector = (function() {
    var a: any = function() {
        this.isIE_ = /MSIE/.test(navigator.userAgent) && !(<any>window).opera;
    ...
    a.prototype.addToGraph_ = function() {
        var b: any = this.graphDiv_ = this.dygraph_.graphDiv;
    ...
    a.prototype.updateVisibility_ = function() {
        var b: any = this.getOption_("showRangeSelector");
        if (b) {
    ...
    a.prototype.resize_ = function() {
        ...
        var c: any = this.dygraph_.layout_.getPlotArea();
        var b: any = 0;
    ...
    a.prototype.createIEPanOverlay_ = function() {
        this.iePanOverlay_ = (<any>document).createElement("div");
    ...
    a.prototype.initInteraction_ = function() {
        var o: any = this;
        var i: any = this.isIE_ ? (<any>document) : (<any>window);
        var u: any = 0;
        var v: any = null;
        var s: any = false;
        var d: any = false;
        var g: any = !this.isMobileDevice_ && !this.isUsingExcanvas_;
        var k: any = new Dygraph.IFrameTarp();
        var p, f, r, j, w, h, x, t, q, c, l;
        var e, n, m;
        p = function(C) {
            var B: any = o.dygraph_.xAxisExtremes();
            var z: any = (B[1] - B[0]) / o.canvasRect_.w;
            var A: any = B[0] + (C.leftHandlePos - o.canvasRect_.x) * z;
            var y: any = B[0] + (C.rightHandlePos - o.canvasRect_.x) * z;
            return [A, y]
        };
        f = function(y) {
        ...
        r = function(C) {
            ...
            var z: any = C.clientX - u;
            if (Math.abs(z) < 4) {
                return true
            }
            u = C.clientX;
            var B: any = o.getZoomHandleStatus_();
            var y: any;
        ...
        w = function() {
            try {
                var z: any = o.getZoomHandleStatus_();
        ...
        h = function(A) {
            if (o.isUsingExcanvas_) {
                ...
                var z: any = o.leftZoomHandle_.getBoundingClientRect();
                var y: any = z.left + z.width / 2;
                z = o.rightZoomHandle_.getBoundingClientRect();
                var B: any = z.left + z.width / 2;
        ...
        t = function(C) {
            ...
            u = C.clientX;
            var B: any = o.getZoomHandleStatus_();
            var E: any = B.leftHandlePos;
            var y: any = B.rightHandlePos;
            var D: any = y - E;
            ...
            var A: any = o.leftZoomHandle_.width / 2;
        ...
        m = function(B, A) {
            var z: any = ["touchstart", "touchend", "touchmove", "touchcancel"];
            for (var y: any = 0; y < z.length; y++) {
        ...
        var b: any = (<any>window).opera ? "mousedown" : "dragstart";
    ...
    a.prototype.drawMiniPlot_ = function() {
        var f: any = this.getOption_("rangeSelectorPlotFillColor");
        var r: any = this.getOption_("rangeSelectorPlotStrokeColor");
        if (!f && !r) {
            return
        }
        var j: any = this.getOption_("stepPlot");
        var v: any = this.computeCombinedSeriesAndLimits_();
        var q: any = v.yMax - v.yMin;
        var p: any = this.bgcanvas_ctx_;
        var n: any = 0.5;
        var e: any = this.dygraph_.xAxisExtremes();
        var o: any = Math.max(e[1] - e[0], 1e-30);
        var g: any = (this.canvasRect_.w - n) / o;
        var u: any = (this.canvasRect_.h - n) / q;
        var t: any = this.canvasRect_.w - n;
        var b: any = this.canvasRect_.h - n;
        var d: any = null,
            c = null;
        p.beginPath();
        p.moveTo(n, b);
        for (var s: any = 0; s < v.data.length; s++) {
            var h: any = v.data[s];
            var l: any = ((h[0] !== null) ? ((h[0] - e[0]) * g) : NaN);
            var k: any = ((h[1] !== null) ? (b - (h[1] - v.yMin) * u) : NaN);
        ...
        p.closePath();
        if (f) {
            var m: any = this.bgcanvas_ctx_.createLinearGradient(0, 0, 0, b);
    ...
    a.prototype.computeCombinedSeriesAndLimits_ = function() {
        var v: any = this.dygraph_.rawData_;
        var u: any = this.getOption_("logscale");
        var q: any = [];
        var d: any;
        var h: any;
        var m: any;
        ...
        var b: any = Number.MAX_VALUE;
        var c: any = -Number.MAX_VALUE;
        for (t = 0; t < q.length; t++) {
            g = q[t][1];
    ...
    a.prototype.placeZoomHandles_ = function() {
        var h: any = this.dygraph_.xAxisExtremes();
        var b: any = this.dygraph_.xAxisRange();
        var c: any = h[1] - h[0];
        var j: any = Math.max(0, (b[0] - h[0]) / c);
        var f: any = Math.max(0, (h[1] - b[1]) / c);
        var i: any = this.canvasRect_.x + this.canvasRect_.w * j;
        var e: any = this.canvasRect_.x + this.canvasRect_.w * (1 - f);
        var d: any = Math.max(this.canvasRect_.y, this.canvasRect_.y + (this.canvasRect_.h - this.leftZoomHandle_.height) / 2);
        var g: any = this.leftZoomHandle_.width / 2;
    ...
    a.prototype.drawInteractiveLayer_ = function() {
        var c: any = this.fgcanvas_ctx_;
        c.clearRect(0, 0, this.canvasRect_.w, this.canvasRect_.h);
        var f: any = 1;
        var e: any = this.canvasRect_.w - f;
        var b: any = this.canvasRect_.h - f;
        var h: any = this.getZoomHandleStatus_();
        c.strokeStyle = "black";
        if (!h.isZoomed) {
            c.beginPath();
            c.moveTo(f, f);
            ...
            var g: any = Math.max(f, h.leftHandlePos - this.canvasRect_.x);
            var d: any = Math.min(e, h.rightHandlePos - this.canvasRect_.x);
    ...
    a.prototype.getZoomHandleStatus_ = function() {
        var c: any = this.leftZoomHandle_.width / 2;
        var d: any = parseFloat(this.leftZoomHandle_.style.left) + c;
        var b: any = parseFloat(this.rightZoomHandle_.style.left) + c;
        return {
            leftHandlePos: d,
            rightHandlePos: b,
