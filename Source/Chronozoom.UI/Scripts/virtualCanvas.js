        ...
        $.widget("ui.virtualCanvas", {
            ...
            */
            function () {
                ...
                this._self.element.bind('mousemove.' + this.widgetName, function (e) {
                    this._self.mouseMove(e);
                });
                this._self.element.bind('mousedown.' + this.widgetName, function (e) {
                    switch(e.which) {
                        case 1:
                            this._self._mouseDown(e)//means that only left click will be interpreted
                            ;
                            break;
                    }
                });
                this._self.element.bind('mouseup.' + this.widgetName, function (e) {
                    switch(e.which) {
                        case 1:
                            this._self._mouseUp(e);
                    }
                });
                this._self.element.bind('mouseleave.' + this.widgetName, function (e) {
                    this._self._mouseLeave(e);
                });
            },
