CREATE TABLE [dbo].[TourBookmark] (
    ...
    CONSTRAINT [FK_TourBookmark_Bookmark] FOREIGN KEY ([BookmarkID]) REFERENCES [dbo].[BookMark] ([ID]),
    CONSTRAINT [FK_TourBookmark_Tour] FOREIGN KEY ([TourID]) REFERENCES [dbo].[Tour] ([ID]),
    CONSTRAINT [FK_TourBookmark_User] FOREIGN KEY ([CreatedBy]) REFERENCES [dbo].[User] ([ID]),
    CONSTRAINT [FK_TourBookmark_User1] FOREIGN KEY ([ModifiedBy]) REFERENCES [dbo].[User] ([ID])
);
