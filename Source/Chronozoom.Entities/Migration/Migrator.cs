...
namespace Chronozoom.Entities.Migration
{
    class Migrator
    {
        ...
        public void Migrate()
        {
            ...
            IEnumerable<TimelineRaw> result = _storage.TimelineSubtreeQuery(new Guid("2b6cd8e0-5833-ceaf-117e-cf74db7fed1f"), new Guid("00000000-0000-0000-0000-000000000000"), new decimal(-6000000000.0), new decimal(-1000000000.0), new decimal(10000.0), 200);
