...
namespace Chronozoom.Entities.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на -- WARNING: best guess on constraint name   -- TODO: confirm name by looking at older copy of db
        ...
        ///ALTER TABLE [Exhibits]          DROP COLUMN [Threshold], [Regime], [UniqueId], [Sequ [остаток строки не уместился]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на DROP TABLE [Bitmasks];
        ///GO
        ///
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на CREATE TABLE [dbo].[Bitmasks]
        ///(
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на INSERT INTO [MigrationHistory] (MigrationId, ProductVersion)
        ///VALUES
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на ALTER TABLE [Timelines]     ALTER COLUMN [Title] NVARCHAR(200);
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на ALTER TABLE [Tours] ALTER COLUMN [Description] NVARCHAR(4000);
        ///GO
        ///
        ///INSERT INTO [MigrationHistory] (MigrationId, ProductVersion)
        ///VALUES
        ...
        /// */
        ///
        ///IF EXISTS (SELECT object_id FROM sys.objects WHERE object_id = OBJECT_ID(N&apos;TimelineSubtreeQuery&apos;) AND type in (N&apos;P&apos;, N&apos;PC&apos; [остаток строки не уместился]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на ALTER TABLE [Timelines]     ALTER COLUMN [FromYear] NUMERIC(18, 7);
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на ALTER TABLE [Timelines] DROP COLUMN [FirstNodeInSubtree], [Predecessor], [Successor];
        ///GO
        ///
        ///INSERT INTO [MigrationHistory] (MigrationId, ProductVersion)
        ///VALUES
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на -- remove users.collection_id (appears to be an existing entity change that previously wasn&apos;t db migrated) --
        ///
        ///IF EXISTS
        ///(
        ...
        ///GO
        ///
        ///-- add new schema  [остаток строки не уместился]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на -- Add PubliclySearchable field to Collections table:
        ...
        ///    (SELECT TO [остаток строки не уместился]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на -- Tighten-up schema so required fields are not null and field lengths are not crazy since they are used in URLs.
        ...
        ///GO
        ///
        ///ALTER TABLE [Users]            [остаток строки не уместился]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на -- Change all existing PubliclySearchable entries to false
        ...
        ///    WHERE
        ///    (s.Title = &apos;chronozoom&apos;     AND c.[Path] = &apos;cosmos&apos;)         OR [остаток строки не уместился]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на -- Add BackgroundUrl and AspectRatio optional columns
        ///-- to Timelines table.
        ///
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на IF NOT EXISTS (SELECT * FROM sys.columns  WHERE [name] = N&apos;OffsetY&apos; AND [object_id] = OBJECT_ID(N&apos;Exhibits&apos;))
        ///BEGIN
        ...
        ///INSERT INTO [MigrationHistory] (MigrationId, ProductVersion)
        ///VALUES
        ///    (&apos;201502170000000_AddYOffsetsAttributes&apos;, &apos;Manual Migrati [остаток строки не уместился]&quot;;.
        /// </summary>
        internal static string _201502170000000_AddYOffsetsAttributes {
            get {
                return ResourceManager.GetString("_201502170000000_AddYOffsetsAttributes", resourceCulture);
            }
        }
        ...
        ///(
        ///	[Id]                [int] IDENTITY(1,1)     NOT N [остаток строки не уместился]&quot;;.
        /// </summary>
        ...
        ///    
        ///    Note that we don&apos;t use sp_MS_marksystemobject as this is not supported i [остаток строки не уместился]&quot;;.
        /// </summary>
