...
namespace Chronozoom.Entities.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to IF NOT EXISTS (SELECT * FROM sys.columns  WHERE [name] = N&apos;OffsetY&apos; AND [object_id] = OBJECT_ID(N&apos;Exhibits&apos;))
        ///BEGIN
        ...
        ///INSERT INTO [MigrationHistory] (MigrationId, ProductVersion)
        ///VALUES
        ///    (&apos;201502170000000_AddYOffsetsAttributes&apos;, &apos;Manual Migratio [rest of string was truncated]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to IF NOT EXISTS (SELECT * FROM sys.columns  WHERE [name] = N&apos;Subject&apos; AND [object_id] = OBJECT_ID(N&apos;Users&apos;))
        ///BEGIN
        ...
        ///GO.
        /// </summary>
        internal static string _201506010000000_AddUserSubject {
            get {
                return ResourceManager.GetString("_201506010000000_AddUserSubject", resourceCulture);
            }
        }
