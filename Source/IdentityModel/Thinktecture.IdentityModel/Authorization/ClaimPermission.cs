...
namespace Thinktecture.IdentityModel.Authorization
{
    ...
    public sealed class ClaimPermission : IPermission, ISecurityEncodable, IUnrestrictedPermission
    {
        ...
        public void Demand()
        {
            ...
            var currentPrincipal = Thread.CurrentPrincipal.AsClaimsPrincipal();
        ...
        private static AuthorizationContext CreateAuthorizationContext(IClaimsPrincipal currentPrincipal, ResourceAction resourceAction)
        {
