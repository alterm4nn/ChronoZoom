...
o	Smoke tests (all tasks from status Deployed)
...
High	•	 All have to work, work.
And working properly.
And everything is available, that is necessary for the rights.
Use the correct input (with permission)	Run first
Normal	•	 All that is desirable, should work, works.
And working properly.
...
Used incorrect input (negative tests)	If possible
